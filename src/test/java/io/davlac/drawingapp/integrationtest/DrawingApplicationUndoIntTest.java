...
import static io.davlac.drawingapp.integrationtest.config.UndoTestParameters.undoParametersConfig;
...
class DrawingApplicationUndoIntTest {
    ...
    private static Stream<Arguments> undoParameters() {
        return undoParametersConfig();
    }

    @ParameterizedTest
    @MethodSource("undoParameters")
    void main_withUndo_shouldUndoAndQuit(String testDescription,
